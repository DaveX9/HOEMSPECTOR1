...
.button-container .cancel-btn:hover {
    ...
    <?php
        ...
        $featured_image = isset($featured_data['image']) ? $featured_data['image'] : "/HOMESPECTOR1/img/thumbnail4.jpg";
    ?>
    ...
    <div class="form-container">
        ...
        <form id="admin-form" enctype="multipart/form-data">
            ...
            <div id="episode-container">
                ...
                $default_episodes = [
                    ["title" => "รีวิวตรวจบ้านเดี่ยว พระเอกดัง!! 'ตงตง เดอะสตาร์'", "image" => "/HOMESPECTOR1/img/thumbnail5.jpg"],
                    ["title" => "ตรวจบ้านหรู 89 ล้าน!", "image" => "/HOMESPECTOR1/img/thumbnail4.jpg"],
                    ["title" => "บ้านหรู CEO 40 ล้าน!", "image" => "/HOMESPECTOR1/img/thumbnail3.jpg"],
                    ["title" => "การตรวจบ้านก่อนโอน", "image" => "/HOMESPECTOR1/img/thumbnail1.jpg"],
                    ["title" => "สนุก มันส์ ฮา กับช่างตรวจ", "image" => "/HOMESPECTOR1/img/thumbnail5.jpg"],
                    ["title" => "บ้านดาราเซเลบ อินฟลู", "image" => "/HOMESPECTOR1/img/thumbnail2.jpg"],
                    ["title" => "ประกันภัยบ้าน แฮปปี้โฮม", "image" => "/HOMESPECTOR1/img/thumbnail3.jpg"]
                ];
            ...
            <div id="carousel-container">
                ...
                // Default carousel
                $default_carousel = [
                    ["title" => "พาดูบ้านหรู 89 ล้าน!", "image" => "/HOMESPECTOR1/img/carousel_thumb1.jpg", "description" => "พาดูบ้านหรู 89 ล้าน! แกรนด์ บางกอก บูเลอวาร์ด ยาร์ด บางนา"],
                    ["title" => "สุดพิเศษ! พาดูบ้านหรู", "image" => "/HOMESPECTOR1/img/thumbnail3.jpg", "description" => "รีวิวตรวจบ้านหรู 40ล้าน! CEO #บุญนําพา"],
                    ["title" => "ตรวจบ้านก่อนโอน by ต.ตรวจบ้าน", "image" => "/HOMESPECTOR1/img/carousel_thumb2.jpg", "description" => "ตรวจบ้านก่อนโอน by ต.ตรวจบ้าน..."],
                    ["title" => "ประกันภัยบ้าน แฮปปี้โฮม ธนชาต", "image" => "/HOMESPECTOR1/img/thumbnail1.jpg", "description" => "ช่วงนี้หน้าฝน อย่ามองข้ามสิ่งนี้🏡⛈️"],
                    ["title" => "สนุก มันส์ ฮา กับช่างตรวจ", "image" => "/HOMESPECTOR1/img/thumbnail3.jpg", "description" => "สนุก มันส์ ฮา กับช่างตรวจ"]
                ];
