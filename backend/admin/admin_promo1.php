...
<div class="form-container">
    ...
    <form id="carousel-form" enctype="multipart/form-data">
        ...
        <div id="carousel-images">
            <div class="form-group">
                <label>Slide 1:</label>
                <img src="/HOMESPECTOR1/img/promotion1.jpg" alt="Slide 1" style="max-width: 200px;" />
                <input type="file" name="carousel_images[]" accept="image/*" />
            </div>
            <div class="form-group">
                <label>Slide 2:</label>
                <img src="/HOMESPECTOR1/img/promotion1.1.jpg" alt="Slide 2" style="max-width: 200px;" />
                <input type="file" name="carousel_images[]" accept="image/*" />
            </div>
            <div class="form-group">
                <label>Slide 3:</label>
                <img src="/HOMESPECTOR1/img/promotion1.2.jpg" alt="Slide 3" style="max-width: 200px;" />
                <input type="file" name="carousel_images[]" accept="image/*" />
            </div>
        </div>
